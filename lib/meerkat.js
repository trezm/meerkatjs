...
var Meerkat = {
	...
	Schema: function(schemaDefinition, name) {
		...
		privateSchema.currentVersionNumber = {
			type: Number,
			default: 1
		}
		...
		mongooseSchema.methods.setCurrentVersionNumber = function(versionNumber, callback) {
			this.currentVersionNumber = versionNumber;
			this.save(callback);
		}

		mongooseSchema.methods.getCurrentVersionNumber = function() {
